        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutReason = table.Column<string>(type: "text", nullable: false),
                    LockoutDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SecurityAlerts_Users_ResolvedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecurityNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecurityNotifications_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityAlerts_ResolvedById",
                schema: "security",
                table: "SecurityAlerts",
                column: "ResolvedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityNotifications_CreatedAt",
                schema: "security",
                table: "SecurityNotifications",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityNotifications_IsRead",
                schema: "security",
                table: "SecurityNotifications",
                column: "IsRead");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityNotifications_NotificationType",
                schema: "security",
                table: "SecurityNotifications",
                column: "NotificationType");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityNotifications_UserId",
                schema: "security",
                table: "SecurityNotifications",
                column: "UserId");
